...
A web based polling system that lets you use a browser to interact with your home server and it's connected IoT devices from anywhere - without exposing your home network to the internet. No third party relay/tunneling apps required.
...
- Go to the control panel page on the website. Press the button to turn the Arduino built in LED on.<br>
